...
BOT_TOKEN = environ.get('BOT_TOKEN', '5264501642:AAFWGNFl54NkV7Hqc6QfA1jfHBaxwD-j7kg')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1921088773').split()]
...
SHORT_API = environ.get("SHORT_API", "75da926e3f248de287cb0a770ea77048012fa926")
